...
This is the *sender* half (a Python service reporting in). The receiving :class:`~benzene.mesh.MeshCollector`
ingests these feeds and answers ``benzene:mesh:query:*`` (see :mod:`benzene.mesh.collector`).
"""
